...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-5">
            <div class="card">
                <div class="text-center card-header">Seja bem vindo a base de conhecimento SGBR!</div>
                ...
                <div class="card-body col-md-11">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="text-center row mb-4">
                            <div class="col-md-4 offset-md-5">
                                <div class="text-center form-check">
                                    ...
                                    <label class="text-center form-check-label" for="remember">
                                        Lembrar-me
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="row mb-0">
                            <div class="text-center col-md-8 offset-md-3">
